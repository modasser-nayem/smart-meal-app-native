   ...
   const MOCK_NOTICES: Notice[] = [
      {
         ...
         body: `Everyone please contribute ${format(800)} for groceries before 6 PM today. Karim will collect from each room.`,
         timeAgo: "2h ago",
         pinColor: "warning",
         postedBy: "Ali Nayem",
         isPinned: true,
      },
      {
         ...
         body: `March billing is now finalized. Total: ${format(42560)}. Please settle any outstanding dues within 3 days.`,
         timeAgo: "Yesterday",
         pinColor: "info",
         postedBy: "Ali Nayem",
      },
      {
         ...
         body: `This month's internet bill of ${format(1000)} has been paid.`,
         timeAgo: "2 days ago",
         pinColor: "success",
